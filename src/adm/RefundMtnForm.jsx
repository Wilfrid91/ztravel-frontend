...
export default function RefundMtnForm() {
  ...
  useEffect(() => {
    if (!mtnData?.refundReferenceId) return
    console.log(mtnData.refundReferenceId)
  ...
  return (
    ...
    >
      ...
      {/* Numéro de téléphone */}
      <div>
        <label>Identifiant de la transaction - Financial Transaction Id.</label>
